...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_X = 7.0;
    public static double PERPENDICULAR_Y = 1;
    public static double X_MULTIPLIER = 0.9165581488530502; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.9208244056728905; // Multiplier in the Y direction
